CREATE TABLE [dbo].[WorkExperienceJobSkills]
(
    ...
    CONSTRAINT [FK_WorkExperienceJobSkill_WorkExperienceSkill] FOREIGN KEY ([SkillId]) REFERENCES [dbo].[WorkExperienceSkills]([Id])
)
